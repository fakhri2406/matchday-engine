...
export const POSITIVE_EVENTS: GameEvent[] = [
  ...
  {
    id: "passCompBonus",
    label: "Pass Completion % Bonus",
    desc: "Ticks if pass accuracy >85% (enter 1 for yes, 0 for no)",
    base: 0.25,
    weights: {
      GK: 0.4,
      CB: 0.7,
  ...
  {
    id: "lastManTackle",
    label: "Last-Man Tackle / Clearance",
    desc: "Preventing a clear goal as last defender (no foul)",
    base: 0.4,
    weights: {
      GK: 0.3,
      CB: 1.0,
